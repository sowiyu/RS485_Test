...
namespace RS485_WinForms_Improved
{
    ...
    public partial class RS485_ImprovedForm : MaterialForm
    {
        ...
        // --- 자동 모드 트리거 신호 정의 ---
        private readonly byte[] triggerSignal1 = { 0x44, 0x10, 0x03, 0x85, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF5, 0x18, 0x00, 0x00, 0xD7, 0x11, 0x55 };
        private readonly byte[] triggerSignal2 = { 0x44, 0x10, 0x03, 0x85, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF5, 0x08, 0x04, 0x00, 0xCE, 0x51, 0x55 };
